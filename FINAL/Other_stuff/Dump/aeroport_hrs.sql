...
CREATE TABLE `hrs` (
  ...
  `sunday_start` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`email`),
  CONSTRAINT `hrs_ibfk_1` FOREIGN KEY (`email`) REFERENCES `users` (`email`)
...
INSERT INTO `hrs` VALUES ('worker@worker.com','19.00','0','0','0','20.00','0','17.00');
